...
guide is also available when you select **Help** while you are working in an
edX course, and from your dashboard of courses.
...
=================================
Resources on the edx.org Web Site
=================================

To help you get started with the edX learning experience, edX offers a course
(of course!). You can find the edX Demo_ course on the edx.org web site.
...
In `BlendedX`_ you can explore ways to blend educational technology with
traditional classroom learning to improve educational outcomes. nded learning
experiences with edX.
...
* `Building and Running an edX Course`_ is a comprehensive guide with
  ...
  You can access relevant sections of this guide by selecting **Help** from
  Studio or the LMS.
